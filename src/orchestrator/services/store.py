...
from orchestrator.lib.errors import execution_not_found, io_error, workflow_locked
from orchestrator.models.execution import ExecutionRecord, ExecutionStatus
...
class WorkflowStore:
    ...
    def get_execution_by_id(self, execution_id: str) -> tuple[str, ExecutionRecord] | None:
        ...
        for workflow_dir in self.workflows_path.iterdir():
            ...
            if exec_dir.exists():
                execution = self.load_execution(workflow_dir.name, execution_id)
